...
const Info = () => (
	<>
		<section>
			<h3>Intent</h3>
			<p>The intent of this application is to view an album collection by custom combinations of credits and details. Drill into a collection by artist, producer, mixer, etc. Look for commonalities, and quickly find albums that meet different criteria. View large collections in unique ways.</p>
			<p>For example, how many <em>David Bowie</em> albums do I have? Which <em>Grunge</em> records from <em>1991</em> do I have? Which <em>Rock</em> albums were produced by <em>Tony Visconti</em>? Of those, which ones did <em>Tony Visconti</em> also mix? Are any of those <em>David Bowie</em> albums?</p>
		</section>
		<section>
			<h3>Use</h3>
